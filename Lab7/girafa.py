...
img = cv2.imread('/content/GIRAFA.jpeg')
...
a = img_gray.max()
_, thresh = cv2.threshold(img_gray, a/2*1.91, a,cv2.THRESH_BINARY_INV)
...
edges_gray = cv2.Canny(image=img_gray, threshold1=a/4, threshold2=a/4)
# Detecção borda com Canny (com blurry)
edges_blur = cv2.Canny(image=img_blur, threshold1=a/4, threshold2=a/4)
